...
{
    private readonly MaintenanceSearchViewModel _vm;

    /// <summary>执行 MaintenanceSearchPage 初始化逻辑。</summary>
    public MaintenanceSearchPage(MaintenanceSearchViewModel vm, ScanService scanSvc)
    {
        InitializeComponent();
        BindingContext = vm;
        _vm = vm;
    ...
    private async void OnScanClicked(object sender, EventArgs e)
    {
        ...
        // 同步 ViewModel
        if (BindingContext is MaintenanceSearchViewModel vm)
        {
