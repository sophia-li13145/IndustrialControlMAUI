...
public partial class OutgoingQualitySearchPage : ContentPage
{
    private readonly OutgoingQualitySearchViewModel _vm;

    /// <summary>执行 OutgoingQualitySearchPage 初始化逻辑。</summary>
    public OutgoingQualitySearchPage(OutgoingQualitySearchViewModel vm)
    {
        InitializeComponent();
        BindingContext = vm;
        _vm = vm;
