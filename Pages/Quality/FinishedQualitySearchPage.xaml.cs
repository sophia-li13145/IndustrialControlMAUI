...
public partial class FinishedQualitySearchPage : ContentPage
{
    private readonly FinishedQualitySearchViewModel _vm;

    /// <summary>执行 FinishedQualitySearchPage 初始化逻辑。</summary>
    public FinishedQualitySearchPage(FinishedQualitySearchViewModel vm, ScanService scanSvc)
    {
        InitializeComponent();
        BindingContext = vm;
        _vm = vm;
