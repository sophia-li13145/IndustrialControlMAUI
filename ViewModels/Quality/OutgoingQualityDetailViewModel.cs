...
namespace IndustrialControlMAUI.ViewModels
{
    ...
    /// 质检单详情页 VM
    /// </summary>
    public partial class OutgoingQualityDetailViewModel : ObservableObject, IQueryAttributable, IQualityDetailExitGuard
    {
        ...
        /// <summary>执行 OutgoingQualityDetailViewModel 初始化逻辑。</summary>
        public OutgoingQualityDetailViewModel(IQualityApi api, IAuthApi authApi, IAttachmentApi attachmentApi, IWorkOrderApi workOrderApi)
        {
            _api = api;
            _authApi = authApi;
        ...
        private async Task LoadAsync()
        {
            ...
            try
            {
                ...
                catch (Exception ex)
                {
                    ...
                    await ShowTip($"获取数采质检结果开关失败：{ex.Message}, OutgoingQualityDetailViewModel");
                }
