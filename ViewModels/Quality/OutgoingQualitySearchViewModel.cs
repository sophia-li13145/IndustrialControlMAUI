...
{
    public partial class OutgoingQualitySearchViewModel : ObservableObject
    {
        ...
        /// <summary>执行 OutgoingQualitySearchViewModel 初始化逻辑。</summary>
        public OutgoingQualitySearchViewModel(IQualityApi qualityapi)
        {
