...
{
    public partial class IncomingQualitySearchViewModel : ObservableObject
    {
        ...
        /// <summary>执行 IncomingQualitySearchViewModel 初始化逻辑。</summary>
        public IncomingQualitySearchViewModel(IQualityApi qualityapi)
        {
